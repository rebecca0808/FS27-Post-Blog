        ...
        <a className="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none"
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <path fillRule="evenodd" clipRule="evenodd"
                  d="M106.854 83.585c.218.608.338 1.263.338 1.943 0 3.307-2.686 5.99-6.001 5.99H17.514c-3.315 0-6.001-2.683-6.001-5.99 
           0-.68.12-1.335.338-1.943L51.86 5.58c1.034-2.874 5.218-2.874 6.252 0l40.742 78.005zM66 62c0 5.523-4.477 10-10 10H40V22h16c5.523 0 10 4.477 10 10v30zm-10-6c2.209 0 4-1.791 4-4V32c0-2.209-1.791-4-4-4H46v28h10z"
        ...
        <ul className="list-unstyled small">
          ...
          <li className="mb-2">Currently v5.3.8.</li>
                    ...
                    <div className="col-6 col-lg-2 offset-lg-1 mb-3">
                        ...
                        <li className="mb-2"><a href="https://cottonbureau.com/people/bootstrap"
                                            target="_blank" rel="noopener">Swag Store</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-6 col-lg-2 mb-3">
                        ...
                        <li className="mb-2">
                            ...
                            target="_blank" rel="noopener">Bootstrap 4</a>
                        </li>
                        ...
                        <li className="mb-2">
                            ...
                            target="_blank" rel="noopener">Examples repo</a>
                        </li>
                        </ul>
                    </div>
